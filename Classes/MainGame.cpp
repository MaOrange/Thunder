...
bool  MainGame::init()
{
	...
	//GameOver
	auto GGLabel = Label::createWithTTF("You have been slain!","times.ttf",40);
	...
	//exist button
	auto backLabel = MenuItemLabel::create(Label::createWithSystemFont("返回","Arial.ttf",40),this,menu_selector(MainGame::CBback));
